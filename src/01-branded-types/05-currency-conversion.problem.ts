...
type AuthorizedUser = Brand<User, "EnsuredUser">;
...
const getConversionRateFromApi = async (
  ...
  return Promise.resolve((amount * 0.82) as Amount);
};
...
const ensureUserCanConvert = (user: User, amount: Amount): AuthorizedUser => {
